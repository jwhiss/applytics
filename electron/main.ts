...
import { initDB, getApplications, addApplication, updateApplication, deleteApplication, getStats, bulkUpsertApplications, getHistory, getGlobalHistory } from './db/index';
